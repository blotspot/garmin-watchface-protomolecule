...
module DataFieldIcons {
  ...
  function drawBatteryFull(dc, x, y, size, penSize) {
    textIcon(dc, x, y, "h");
  }
  ...
  function drawNoHeartRate(dc, x, y, size, penSize) {
    textIcon(dc, x, y, "P");
  }
  ...
  function drawBluetoothConnection(dc, x, y, size, penSize) {
    textIcon(dc, x, y, "b");
  }

  function drawNoBluetoothConnection(dc, x, y, size, penSize) {
    textIcon(dc, x, y, "B");
  }

  function drawAlarms(dc, x, y, size, penSize) {
    textIcon(dc, x, y, "a");
  }

  function textIcon(dc, x, y, string) {
    var font = Application.getApp().gIconsFont;
